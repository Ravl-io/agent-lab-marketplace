...
6. **Check the security clauses explicitly**, on every deliverable. Credentials and
   production personal data are the two that carry the highest severity and the two most
   often shipped by accident. Search for them; do not assume their absence.
