---
name: extract-graph
description: TODO — say what this extracts and WHEN to run it. It is the only part the model sees before deciding to use the skill.
---
...
Every node carries `source`: the file, and the table or section inside it. Not optional. An
...
Read each edge aloud as a sentence before you write it — "Account on_plan Plan". A backwards
